package com.blueline.net.sms.connect.manager.tcp;
...
import com.blueline.net.sms.manager.tcp.TCPClientEndpointEntity;
import com.blueline.net.sms.manager.tcp.TCPServerEndpointEntity;
