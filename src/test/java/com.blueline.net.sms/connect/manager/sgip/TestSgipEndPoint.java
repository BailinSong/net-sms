package com.blueline.net.sms.connect.manager.sgip;

import com.blueline.net.sms.codec.sgip12.codec.Sgip2CMPPBusinessHandler;
...
import com.blueline.net.sms.handler.sgip.SgipReportRequestMessageHandler;
import com.blueline.net.sms.manager.EndpointEntity.ChannelType;
import com.blueline.net.sms.manager.EndpointManager;
import com.blueline.net.sms.manager.sgip.SgipClientEndpointEntity;
import com.blueline.net.sms.manager.sgip.SgipServerChildEndpointEntity;
import com.blueline.net.sms.manager.sgip.SgipServerEndpointEntity;
