package com.blueline.net.sms.session;
...
public abstract class AbstractSessionStateManager<K, T extends BaseMessage> extends ChannelDuplexHandler {
	...
	private final static ScheduledThreadPoolExecutor msgResend = new ScheduledThreadPoolExecutor(Integer.valueOf(Property.get("GlobalMsgResendThreadCount",4)), new ThreadFactory() {
